	...
	private class OptionPaneEventHandler implements ActionListener, ListSelectionListener, FocusListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (e.getSource() == endChatButton) {
				...
				// If disconnect, then send disconnect msg to all connected
				// clients and close chat
	...
	public void displayMessage(Message msg) {
		...
		try {
			...
			JOptionPane.showMessageDialog(MainGUI.getInstance(),
					"Recieved a broken message from " + msg.getSender() + ": \n" + msg.getMessage(), "Broken message",
